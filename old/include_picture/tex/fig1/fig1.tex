...
%	\draw[help lines, color=black!30, step=1cm,ultra thin](0,0)grid(10,12);
	...
	\begin{scope}
		...
		\node at (0,1.5)[left]{$0$};
		\draw [very thick,black](0,1.5)--(0.8,2.5)--(2.4,0.5);
				\draw [very thick,blue,->](2.4,0.5)--(3.2,1.5);
	\end{scope}
	...
	\begin{scope}[shift={(0,4)}]
		...
		\draw [dashed,very thick,black](0,1.5)--(4,1.5);
		\node at (0,1.5)[left]{$0$};
		\draw [very thick,black](0,1.5)--(0.8,2.5);
		\draw [very thick,blue,->](0.8,2.5)--(2.4,0.5);
	\end{scope}
	...
	\begin{scope}[shift={(0,8)}]
		...
		\draw [dashed,very thick,black](0,1.5)--(4,1.5);
		\node at (0,1.5)[left]{$0$};
		\draw [very thick,blue,->](0,1.5)--(0.8,2.5);
	\end{scope}
...
,		\node at(6.5,0.5)[right,shift={(-0.1,0)}]{\bf Magnet};
	...
	\draw [ultra thick,black,dashed](9.6,2.5)--(9.6,5.5);
	\draw [ultra thick,black,dashed](9.8,1.5)--(9.8,9.5);
	\draw [ultra thick,black,dashed](10,7)--(10,9.5);
	...
	\begin{scope}
		\draw [line width=2pt,->,shift={(1.7,0.45)}](4.4,0)--(4.8,0);
		\draw [line width=2pt,->,shift={(3.4,0.25)}](4.4,0)--(4.8,0);
		\draw [line width=2pt,->,shift={(3.2,2.75)}](4.4,0)--(4.8,0);
	\end{scope}
	
	\begin{scope}[shift={(0,4)}]
		\draw [line width=2pt,->,shift={(10.8,0.45)},xscale=-1](4.2,0)--(5,0);
		\draw [line width=2pt,->,shift={(3.2,0.25)}](5,0)--(4.2,0);
		\draw [line width=2pt,->,shift={(3,2.75)}](5,0)--(4.2,0);
	\end{scope}
