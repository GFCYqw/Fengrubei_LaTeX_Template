...
% 本文档以 第三十四届“冯如杯”格式规范编写，请根据当年届次和赛道要求自行修改。
% 例如搜索替换 “三十四届”->“三十五届”；“创意赛道”->“主赛道”

\documentclass{FRB-style}
% \documentclass[zihao=-4, scheme=chinese, heading=true, fontset=windows]{ctexart}
% \usepackage{FRB-style}

% 赛道届次的宏定义，可以在此处修改，后面使用\Fengrubei{}以引用该宏
...
%====================封面====================
\begin{titlepage}
	\leftline{\includegraphics[scale=1]{xiaohui.png}}
	\vspace{32pt}
	\begin{center}
...
\pagenumbering{roman}	% 摘要目录页页码小写罗马数字

% \begin{spacing}{1.625}	% 对应 \end{spacing} 在参考文献结尾
\xiaosi	% 全文字号控制
...
\section*{\textbf{Abstract}} % XSP 2023/3/8: Abstract 加粗
	...
	%\lhead{} 
	\chead{\xiaowu 北京航空航天大学\Fengrubei{}参赛作品} % 设置居中页眉
...
\section*{结论}
	...
	\subsection{优劣分析与未来优化}
		...
		% \end{spacing}	% 对应开头的 \begin{spacing}
...
\section{电路设计}
	...
	\begin{figure}[!h]
		...
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\textwidth]{SCH/SCH_ADC_And_MCU_1-P1_2024-04-03.pdf}
			\caption{SCH\_ADC\_And\_MCU}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\linewidth]{SCH/SCH_Base_Connector_1-P1_2024-04-03.pdf}
		...
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\linewidth]{SCH/SCH_Controller_1-P1_2024-04-03.pdf}
			\caption{SCH\_Controller}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\linewidth]{SCH/SCH_Motor_1-P1_2024-04-03.pdf}
			\caption{SCH\_Motor}
		\end{subfigure}
		\hfill
		\vskip 1em
		...
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\linewidth]{SCH/SCH_Power_1-P1_2024-04-03.pdf}
			\caption{SCH\_Power}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.47\textwidth}
			\centering
			\includegraphics[width=\linewidth]{SCH/SCH_TIA_1-P1_2024-04-03.pdf}
			\caption{SCH\_TIA}
		\end{subfigure}
		\hfill
...
\section{示例代码}
	...
	\lstinputlisting[
		style       =   Python,
		caption     =   {\bf PID 控制恒流模式示例代码},
		%	label       =   {xxx.py}
	]{./code/PID控制恒流模式示例代码.py}
	
	\clearpage
	\lstinputlisting[
		style       =   Python,
		caption     =   {\bf 对数拟合算法示例代码},
		%	label       =   {xxx.py}
	]{./code/对数拟合算法示例代码.py}
	...
	\lstinputlisting[
		style       =   Python,
		caption     =   {\bf 二维图像重建算法示例代码},
		%	label       =   {xxx.py}
	]{./code/二维图像重建算法示例代码.py}
	
	\clearpage
	\lstinputlisting[
		style       =   Python,
		caption     =   {\bf 三维图像重建算法示例代码},
		%	label       =   {xxx.py}
	]{./code/三维图像重建算法示例代码.py}
	%====================附录B====================
	% \end{appendices}
\end{document}
